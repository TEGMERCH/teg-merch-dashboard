      ...
      React.createElement("div",{style:{display:"flex",gap:12,marginBottom:16,flexWrap:"wrap"}},
        React.createElement("div",{style:{flex:1,minWidth:260,background:"#0A0A0F",borderRadius:8,padding:"12px 14px",border:"1px solid #1E1E2E"}},
          ...
          React.createElement("div",{style:{display:"flex",alignItems:"center",gap:8,flexWrap:"wrap"}},
            React.createElement("span",{style:{fontSize:10,color:"#555"}},"From"),
            React.createElement("input",{type:"date",value:periodA.from,onChange:e=>setPeriodA(p=>({...p,from:e.target.value})),style:{background:"#111118",border:"1px solid #1E1E2E",color:"#fff",borderRadius:6,padding:"5px 8px",fontSize:11,flex:1}}),
            React.createElement("span",{style:{fontSize:10,color:"#555"}},"To"),
            React.createElement("input",{type:"date",value:periodA.to,onChange:e=>setPeriodA(p=>({...p,to:e.target.value})),style:{background:"#111118",border:"1px solid #1E1E2E",color:"#fff",borderRadius:6,padding:"5px 8px",fontSize:11,flex:1}}),
        ...
        React.createElement("div",{style:{flex:1,minWidth:260,background:"#0A0A0F",borderRadius:8,padding:"12px 14px",border:"1px solid #1E1E2E"}},
          ...
          React.createElement("div",{style:{display:"flex",alignItems:"center",gap:8,flexWrap:"wrap"}},
            React.createElement("span",{style:{fontSize:10,color:"#555"}},"From"),
            React.createElement("input",{type:"date",value:periodB.from,onChange:e=>setPeriodB(p=>({...p,from:e.target.value})),style:{background:"#111118",border:"1px solid #1E1E2E",color:"#fff",borderRadius:6,padding:"5px 8px",fontSize:11,flex:1}}),
            React.createElement("span",{style:{fontSize:10,color:"#555"}},"To"),
            React.createElement("input",{type:"date",value:periodB.to,onChange:e=>setPeriodB(p=>({...p,to:e.target.value})),style:{background:"#111118",border:"1px solid #1E1E2E",color:"#fff",borderRadius:6,padding:"5px 8px",fontSize:11,flex:1}}),
            ...
            React.createElement("table",{style:{width:"100%",borderCollapse:"collapse",fontSize:11}},
              React.createElement("thead",null,
                ...
                hasPeriods && React.createElement("tr",null,
                  ...
                  React.createElement("th",{style:thSt("#22C55E")},"Gross"),
                  React.createElement("th",{style:thSt(accent)},"Actual"),
                  React.createElement("th",{style:thSt("#D4A017")},"Avg/Unit"),
                  React.createElement("th",{style:{...thSt("#4ECDC4"),borderLeft:"1px solid #1E1E2E33"}},"Units"),
                  React.createElement("th",{style:thSt("#22C55E")},"Gross"),
                  React.createElement("th",{style:thSt(accent)},"Actual"),
                  ...
                  return [
                    React.createElement("tr",{key:catName,style:{borderBottom:isOpen?"none":"1px solid #1E1E2E22",cursor:"pointer"},
                      ...
                      hasPeriods ? React.createElement(React.Fragment,null,
                        ...
                        React.createElement("td",{style:tdSt("#22C55E")},fmtMoney(a.gross)),
                        React.createElement("td",{style:tdSt(accent)},fmtMoney(a.revenue)),
                        ...
                        React.createElement("td",{style:tdSt("#22C55E")},fmtMoney(b.gross), badge(b.gross,a.gross)),
                        React.createElement("td",{style:tdSt(accent)},fmtMoney(b.revenue), badge(b.revenue,a.revenue)),
                        ...
                        React.createElement("td",{style:tdSt("#22C55E")},fmtMoney(base.gross)),
                        React.createElement("td",{style:tdSt(accent)},fmtMoney(base.revenue)),
