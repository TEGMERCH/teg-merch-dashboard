...
function BrandDashboard({ data, accent, allStores, label }) {
  ...
  return React.createElement("div", null,
    ...
    /* Line chart — each category as its own line */
    chartData.length>0 && React.createElement("div",{style:{background:"#111118",border:"1px solid #1E1E2E",borderRadius:10,padding:20,marginBottom:16}},
      ...
      React.createElement(Recharts.ResponsiveContainer,{width:"100%",height:320},
        chartMode==="line"
          ? React.createElement(Recharts.LineChart,{data:chartData},
              ...
              ...activeCats.map((cat,i)=>React.createElement(Recharts.Line,{key:cat,type:"monotone",dataKey:cat,stroke:COLORS2[cats.findIndex(c=>c.name===cat)%12],strokeWidth:2,dot:{r:3},activeDot:{r:5},connectNulls:false}))
            )
